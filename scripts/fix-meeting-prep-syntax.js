...
var allData = await httpGet('https://api.crmworkspace.com/v1/contacts?per_page=250', { 'ACCESS_TOKEN': process.env.WEALTHBOX_TOKEN });
...
// 2. Fetch notes
var notesData = await httpGet('https://api.crmworkspace.com/v1/notes?contact_id=' + contact.id + '&per_page=5', { 'ACCESS_TOKEN': process.env.WEALTHBOX_TOKEN });
